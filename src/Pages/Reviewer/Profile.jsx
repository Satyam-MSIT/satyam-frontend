    ...
    <div className="flex">
      ...
      <div className="m-12 border w-full">
        <img
          ...
          src="https://images.pexels.com/photos/937782/pexels-photo-937782.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
          alt=""
        />
        <div className="flex -mt-8 mx-4">
          ...
          <div className="mt-8">
            <div className="flex items-center align-middle justify-between">
              ...
              <button onClick={updation} className="bg-red-500 text-white rounded-lg px-4 py-1 my-2">
                {val === false ? "Update" : "Save"}
              </button>
            </div>
            <input
              type="text"
              ...
              className={val ? "bg-gray-200 rounded-md px-1 text-sm text-gray-600 outline-none" : "text-sm"}
            ...
            <textarea
              ...
              disabled={val ? false : true}
              className={
                val ? "bg-gray-200 rounded-md px-1 text-sm text-gray-600 outline-none" : " text-justify text-sm"
              }
              onChange={(e) => setData({ ...data, about: e.target.value })}
            />

            <p className="mt-4 font-medium my-1">Field of Interest</p>
            <span class="bg-green-200 text-blue-600-800 text-xs font-medium me-2 px-2.5 py-1  my-1 rounded dark:bg-gray-700 dark:text-blue-600-400 border border-blue-600-400">
              Technology
            </span>
            <span class="bg-green-200 text-blue-600-800 text-xs font-medium me-2 px-2.5 py-1  my-1 rounded dark:bg-gray-700 dark:text-blue-600-400 border border-blue-600-400">
              Cricket
